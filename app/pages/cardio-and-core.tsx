...
import { CardioCore } from '@/constants/Cardio&Core';
...
const navigation = useNavigation<NavigationProp<RootStackParamList>>();
    ...
    const [cardioCore, setCardioCore] = useState<{ id: number; title: string; description: string; image: any; videoUrl?: string; subtitle: string[]; instructions: string | string[]; }[]>([]);

    useEffect(() => { 
        setCardioCore(cardioCore);
    })
    ...
    const toggleModal = (cardioCore: { id: number; title: string; description: string; image: any; videoUrl?: string; subtitle?: string | string[]; instructions: string | string[]; } | null) => {
        if (cardioCore) {
            setSelectedItem({
                ...cardioCore,
                subtitle: Array.isArray(cardioCore.subtitle) ? cardioCore.subtitle : cardioCore.subtitle ? [cardioCore.subtitle] : [],
            });
        } else {
            setSelectedItem(null);
        }
        setVisible(!!cardioCore);
    };
    ...
    const headerComp = <Text style={styles.textHeader}> Cardio and Core Workouts</Text>
