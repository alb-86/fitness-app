...
import { BackWorkouts } from "@/constants/BackWorkouts";
...
const navigation = useNavigation<NavigationProp<RootStackParamList>>();
    ...
    const [backWorkouts, setBackWorkouts] = useState<{ id: number; title: string; description: string; image: any; videoUrl?: string; subtitle: string[]; instructions: string | string[]; }[]>([]);

    useEffect(() => {
            setBackWorkouts(backWorkouts)
    })
    ...
    const toggleModal = (backWorkouts: { id: number; title: string; description: string; image: any; videoUrl?: string; subtitle: string[]; instructions: string | string[]; } | null) => {
        if (backWorkouts) {
            setSelectedItem(backWorkouts);
            setVisible(true);
        } else {
    ...
    const headerComp = <Text style={styles.textHeader}> Back Workouts </Text>
