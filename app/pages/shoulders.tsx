...
import { Shoulders } from '@/constants/Shoulders';
...
const navigation = useNavigation<NavigationProp<RootStackParamList>>();
    ...
    const [shoulders, setShoulders] = useState<{ id: number; title: string; description: string; image: any; videoUrl?: string; subtitle: string[]; instructions: string | string[]; }[]>([]);
    ...
    const toggleModal = (shoulders: React.SetStateAction<{ id: number; title: string; description: string; image: any; videoUrl?: string; subtitle: string[]; instructions: string | string[]; } | null>) => {
    if (shoulders) {
        setSelectedItem(shoulders);
    } else {
    ...
    const headerComp = <Text style={styles.textHeader}> Shoulder Workouts </Text>
                    ...
                    <TouchableOpacity onPress={() => toggleModal(null)} style={styles.modalClose}>
                        ...
                        <>
                            ...
                            {selectedItem.videoUrl && (
                                ...
                                <Text style={styles.modalTitle}>Video goes here</Text>
                            )}
                                    </View>
                                </View>
                </Modal>
